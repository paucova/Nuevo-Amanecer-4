            ...
            Row() {
                ...
                Column() {
                    Box(
                        ...
                        Image(
                            painter = painterResource(id = R.drawable.columna2),
                            contentDescription = null,
                            modifier = Modifier.fillMaxSize()
                        )
                    }
            ...
            Row() {
                ...
                Column() {
                    Box(
                        ...
                        Image(
                            painter = painterResource(id = R.drawable.columna3),
                            contentDescription = null,
                            modifier = Modifier.fillMaxSize()
                        )
                    }
                ...
                Column() {
                    Box(
                        ...
                        Image(
                            painter = painterResource(id = R.drawable.columna4),
                            contentDescription = null,
                            modifier = Modifier.fillMaxSize()
                        )
                    }
